...
```{r keep only hainleite shape for GFW, eval=FALSE}
hainleite <- hainleite %>%
  st_make_valid()
...
area_hainleite <- hainleite %>%
  ...
  ggplot() +
    ...
    labs(title = paste0("<span style='color:", 
                        color_loss, 
                        ";'>Schadflächen</span> im Vergleich zur <span style='color:",
                        color_gain,
                        ";'>gesamten Hainleite</span>"), x = "", y = "Hektar", caption = "Quelle: Global Forest Watch") +
    theme_ipsum() +
    theme(
...
overall_map <- ggplot() +
  ...
  labs(title = paste0("2018 bis Mitte 2020 sind <span style='color:", 
                      ...
                      " Hektar Hainleite zu Schaden gekommen</span>"), caption = "Quellen: Forst und Geoportal Thüringen") +
  theme_void() +
  theme(
    plot.title = element_markdown()
  )
